...
import { Zap, BookOpen, Presentation, BookMarked, Sparkles } from "lucide-react";
...
const MODES: { id: Mode; label: string; icon: React.ElementType; desc: string }[] = [
  ...
  { id: "paper-reading", label: "精读", icon: BookMarked, desc: "生成系统读书笔记" },
  { id: "deep-learn", label: "伴读", icon: BookOpen, desc: "章节导读与提问" },
  { id: "present", label: "分享", icon: Presentation, desc: "准备读书会材料" },
  { id: "skill", label: "生成技能", icon: Sparkles, desc: "沉淀成 Codex skill" },
];
